...
HOST_IP="192.168.88.5"
HOST_USER="${1:-}"
HOST_DIR="/home/ky/opt/posfont"
APP_PORT="888"
API_BASE_URL="http://192.168.88.5:8080"
...
if [[ -z "${HOST_USER}" ]]; then
  ...
  echo "  $0 ky"
  echo "  $0 ky 888"
  echo "  $0 ky 888 http://192.168.88.5:8080"
  echo "  $0 ky /home/ky/opt/posfont 888 http://192.168.88.5:8080"
  exit 1
fi
...
ssh "${HOST_USER}@${HOST_IP}" "docker load -i '${HOST_DIR}/${TAR}'"
